...
class TableViewController: UITableViewController {
    ...
    @IBAction func refrehControllAction(_ sender: Any) {
        loadFunc {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let atrict = articles[indexPath.row]
        cell.textLabel?.text = atrict.title
        cell.detailTextLabel?.text = atrict.publishedAt
